...
;; 대문자 K를 누르면 각 package에 대한 상세 org문서를 볼 수 있다.
;;; Commentary:
;; My commentary
;;; Code:
...
(doom! :input
       ...
       :checkers
       (syntax +everywhere +childframe)  ; tasing you for every semicolon you forget(this include Flycheck)
