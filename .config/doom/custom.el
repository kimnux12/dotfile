(custom-set-variables
 ...
 '(package-selected-packages
   '(live-py-mode yasnippet-snippets yasnippet @ a dired-preview evil-tutor markdown-soma olivetti org-bullets org-fancy-priorities org-modern org-preview-html)))
(custom-set-faces
